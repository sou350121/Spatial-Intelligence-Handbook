...
| File | Topic | Tier |
|---|---|---|
| [depth_anything_v2_dissection.md](./depth_anything_v2_dissection.md) | Depth Anything v2 — unlabeled-data 的胜利 | ⚡ relative |
| [metric3d_dissection.md](./metric3d_dissection.md) | Metric3D v1/v2 — 用 canonical-camera 技巧得到度量深度 | 🔧 metric |
| [moge_dissection.md](./moge_dissection.md) | MoGe — affine-invariant 几何 loss + multi-head | 📖 relative |
| [foundationstereo_dissection.md](./foundationstereo_dissection.md) | FoundationStereo — NVIDIA 的零样本立体 | 🔧 metric (stereo) |
