...
| File | Topic | Tier |
|---|---|---|
| [`3dgs_original_dissection.md`](./3dgs_original_dissection.md) | Kerbl et al. SIGGRAPH 2023 — rasterizer、training loop、deployment envelope | ⚡ |
| [`4dgs_dynamic_scenes.md`](./4dgs_dynamic_scenes.md) | Wu et al. CVPR 2024 — 针对运动物体的 temporal 扩展 | 🔧 |
| [`gs_slam_dissection.md`](./gs_slam_dissection.md) | Yan et al. CVPR 2024 — SLAM 环路内的 gaussian map 构建 | 🔧 |
| [`mip_splatting.md`](./mip_splatting.md) | Yu et al. CVPR 2024 — 多尺度观看的 anti-aliasing 修复 | 🔧 |
| [`mip_splatting_dissection.md`](./mip_splatting_dissection.md) | Mip-Splatting 抗锯齿正典 — 3D 平滑 + 2D Mip filter（CVPR 2024 Best Student Paper）| 🔧 |
| [`github_failure_atlas.md`](./github_failure_atlas.md) | 四件套（3DGS / 4DGS / GS-SLAM / Mip-Splatting）GitHub issues 失败图谱（ecosystem 文档）| — |
