...
> **Foundations** 是跨 embodiment 共享的底层 — 3DGS / VGGT / Depth Foundation 这些"工具箱"原语，无论你做 manipulation、aerial 还是 marine，最终都会回到这里。
>
> 目前收录 **14 篇深度解析** + **8 区导读**，是华语世界对空间智能底层最系统的拆解。
>
> 不知道从哪开始？先选你的角色 ↓
...
**14** dissections · **8** zones · 部分由 [Pulsar](https://github.com/sou350121/Pulsar-KenVersion) 自动生成、部分人工撰写。
